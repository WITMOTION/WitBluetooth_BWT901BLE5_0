...
namespace Wit.Example_WTVB01BT50.vb01
{
    public class WTVB01 : IAttitudeSensorApi
    {
        /// <summary>
        /// 设备模型
        /// </summary>
        ...
        /// 记录数据委托
        /// </summary>
        public delegate void OnRecordHandler(WTVB01 WTVB01);
        ...
        public WTVB01(string mac, string deviceName)
        {
            // 创建一个连接蓝牙的设备模型
